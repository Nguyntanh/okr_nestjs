...
> = {
  ...
  meta: {
    modelProps: "user" | "cycle" | "objective" | "keyResult" | "checkIn";
    ...
    Cycle: {
      ...
      operations: {
        ...
        count: {
          ...
          result:
            | runtime.Types.Utils.Optional<Prisma.CycleCountAggregateOutputType>
            | number;
        };
      };
    };
 ...
 */
export type EnumObjectiveTypeFieldRefInput<$PrismaModel> = FieldRefInputType<
  $PrismaModel,
  "ObjectiveType"
>;
